...
const students = [
    ...
    { roll: 23, name: "Madhumita Chakrabortty", gender: "Girl" },
    { roll: 24, name: "Mohit Bouri", gender: "Boy" },
    { roll: 25, name: "Nandamuri Mohit Kumar", gender: "Boy" },
    { roll: 26, name: "Oishee Chakrabarti", gender: "Girl" },
    { roll: 27, name: "Pousam Karmakar", gender: "Boy" },
    { roll: 28, name: "Priya Bharti", gender: "Girl" },
    { roll: 29, name: "Mohammad Rayyan Ali", gender: "Boy" },
    { roll: 30, name: "Riya Bauri", gender: "Girl" },
    { roll: 31, name: "Shakshi Kumari", gender: "Girl" },
    { roll: 32, name: "Shanell McNair Singh", gender: "Girl" },
    { roll: 33, name: "Shibam Gorain", gender: "Boy" },
    { roll: 34, name: "Shivam Bauri", gender: "Boy" },
    { roll: 35, name: "Md. Soheb", gender: "Boy" },
    { roll: 36, name: "Sijan Bauri", gender: "Boy" },
    { roll: 37, name: "Sonakshi", gender: "Girl" },
    { roll: 38, name: "Soumya Tripathi", gender: "Girl" },
    { roll: 39, name: "Sritam Mahato", gender: "Boy" },
    { roll: 40, name: "Subham Chandra", gender: "Boy" },
    { roll: 41, name: "Tanvir Iqbal", gender: "Boy" },
    { roll: 42, name: "Tushar Kanti Garain", gender: "Boy" },
    { roll: 43, name: "Visesh Rajak", gender: "Boy" }
];
