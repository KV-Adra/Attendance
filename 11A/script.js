...
const students = [
  { roll: 1, name: "Aditi Digar", gender: "Boy" },
  { roll: 2, name: "Aditi Raj", gender: "Boy" },
  { roll: 3, name: "Aishee Mistri", gender: "Boy" },
  { roll: 4, name: "Anannya Mahato", gender: "Boy" },
  { roll: 5, name: "Angshuman Bauri", gender: "Boy" },
  { roll: 6, name: "Anjali Surin", gender: "Boy" },
  { roll: 7, name: "Ankita Mahajan", gender: "Boy" },
  { roll: 8, name: "Antara Chakraborty", gender: "Boy" },
  { roll: 9, name: "Anubhab Mishra", gender: "Boy" },
  { roll: 10, name: "Arka Karmakar", gender: "Boy" },
  { roll: 11, name: "Barsha Singh Sardar", gender: "Boy" },
  { roll: 12, name: "Bishal Pandey", gender: "Boy" },
  { roll: 13, name: "Debayan Ash", gender: "Boy" },
  { roll: 14, name: "Devapriya Biju", gender: "Boy" },
  { roll: 15, name: "Dhruvojyoti Das", gender: "Boy" },
  { roll: 16, name: "Ishant Singh", gender: "Boy" },
  { roll: 17, name: "Isha Soy", gender: "Boy" },
  { roll: 18, name: "Joyashri Nandi", gender: "Boy" },
  { roll: 19, name: "Megha Hansda", gender: "Boy" },
  { roll: 20, name: "Mohit Kumar", gender: "Boy" },
  { roll: 21, name: "Om Sharma", gender: "Boy" },
  { roll: 22, name: "Pragati Kumari", gender: "Boy" },
  { roll: 23, name: "Preetam Mandal", gender: "Boy" },
  { roll: 24, name: "Prity Mahato", gender: "Boy" },
  { roll: 25, name: "Purba Chakraborty", gender: "Boy" },
  { roll: 26, name: "Rajdeep Kar", gender: "Boy" },
  { roll: 27, name: "Rohan Roy", gender: "Boy" },
  { roll: 28, name: "Ronit Gorai", gender: "Boy" },
  { roll: 29, name: "Rudrika Rajak", gender: "Boy" },
  { roll: 30, name: "Samrat Banerjee", gender: "Boy" },
  { roll: 31, name: "Sartaj Ansary", gender: "Boy" },
  { roll: 32, name: "Saujanya Mahanty", gender: "Boy" },
  { roll: 33, name: "Shambhavi Anand", gender: "Boy" },
  { roll: 34, name: "Shibam Chatterjee", gender: "Boy" },
  { roll: 35, name: "Shivani Kumari", gender: "Boy" },
  { roll: 36, name: "Shruti Tiwari", gender: "Boy" },
  { roll: 37, name: "Subhajit Bouri", gender: "Boy" },
  { roll: 38, name: "Supriya Das", gender: "Boy" },
  { roll: 39, name: "Tejas Sharma", gender: "Boy" },
  { roll: 40, name: "Ashmeet Dubey", gender: "Boy" }
];
